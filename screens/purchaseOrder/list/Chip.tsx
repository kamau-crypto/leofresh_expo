import { PurchaseOrderStatusEnum } from "@/constants";
import { StyleSheet } from "react-native";
import { Chip } from "react-native-paper";

export function CompileChipStatus({ status }: { status: string }) {
	switch (true) {
		case status === PurchaseOrderStatusEnum.COMPLETED:
			return (
				<Chip
		...
		case status === PurchaseOrderStatusEnum.DRAFT:
			return (
				<Chip
		...
		case status === PurchaseOrderStatusEnum.UNDER_REVIEW:
			return (
				<Chip
					...
					{PurchaseOrderStatusEnum.UNDER_REVIEW}
				</Chip>
			);
