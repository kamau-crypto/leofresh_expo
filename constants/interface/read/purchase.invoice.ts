...
export interface ReadCreatedPurchaseInvoice {
	name: string;
	owner: string;
	creation: Date;
	modified: Date;
	...
	advances: any[];
	advance_tax: any[];
	payment_schedule: PIPaymentSchedule[];
}

export interface ReadPIMessageItem {
	name: string;
	owner: string;
	creation: Date;
	modified: Date;
...
export interface PIPaymentSchedule {
	name: string;
	owner: string;
	creation: Date;
	modified: Date;
