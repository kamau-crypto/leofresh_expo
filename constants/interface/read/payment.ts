export interface ReadPaymentEntry {
	data: ReadPaymentEntryData;
}

export interface ReadPaymentEntryData {
	name: string;
	owner: string;
	creation: Date;
	modified: Date;
...
export interface ReadSubmittedPaymentEntry {
	message: ReadSubmittedPaymentMsg;
}

export interface ReadSubmittedPaymentMsg {
	advance_reconciliation_takes_effect_on: string;
	amended_from: null;
	apply_tax_withholding_amount: number;
	auto_repeat: null;
