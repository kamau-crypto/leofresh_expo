export interface CreatePurchaseReceipt {
	supplier: string;
...
export interface CreatedPurchaseReceipt {
	name: string;
	owner: string;
	creation: Date;
	modified: Date;
...
export interface SubmittedPurchaseReceipt {
	message: SubmittedPurchaseReceiptMessage;
}

export interface SubmittedPurchaseReceiptMessage {
	name: string;
	owner: string;
	creation: Date;
	modified: Date;
	...
	is_old_subcontracting_flow: number;
	doctype: string;
	items: SubmittedPurchaseReceiptItem[];
	taxes: any[];
	pricing_rules: any[];
	supplied_items: any[];
}

export interface SubmittedPurchaseReceiptItem {
	name: string;
	owner: string;
	creation: Date;
	modified: Date;
