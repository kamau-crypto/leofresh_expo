export interface CreatePurchaseInvoices {
	supplier: string;
...
export interface CreatedPurchaseInvoice {
	data: CreatedPurchaseInvoiceData;
	_server_messages: string;
}

export interface CreatedPurchaseInvoiceData {
	name: string;
	owner: string;
	creation: Date;
	modified: Date;
	...
	doctype: string;
	items: CreatedPurchaseInvoiceItem[];
	taxes: any[];
	...
	advances: any[];
	advance_tax: any[];
	payment_schedule: CreatedPurchaseInvoicePaymentSchedule[];
}

export interface CreatedPurchaseInvoiceItem {
	name: string;
	owner: string;
	creation: Date;
	modified: Date;
...
export interface CreatedPurchaseInvoicePaymentSchedule {
	name: string;
	owner: string;
	creation: Date;
	modified: Date;
